...
})({"fJVQr":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4cd1724ded16d7d3";
"use strict";
...
},{}],"idAF4":[function(require,module,exports,__globalThis) {
...
(async function() {
    try {
        ...
        const datasets = top4Times.map((time)=>{
            const timeData = json.filter((item)=>item.time === time).reduce((acc, item)=>{
...
},{"chart.js/auto":"a3bOj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["fJVQr","idAF4"], "idAF4", "parcelRequire30ab", {})

//# sourceMappingURL=chart.js.ed16d7d3.js.map
