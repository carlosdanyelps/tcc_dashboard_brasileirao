...
mapeamento = {
    ...
    4: ("Goiás", "goias-footballlogos-org.png"),
    5: ("Internacional", "sc-internacional-footballlogos-org.png"),
    6: ("Criciúma", "criciuma.png"),
    ...
    10: ("Vitória", "vitoria-footballlogos-org.png"),
    ...
    21: ("Paraná", "parana-clube-de-curitiba-pr-logo-png-transparent.png"),
    22: ("São Caetano", "Associação_Desportiva_São_Caetano.png"),
    23: ("São Paulo", "sao-paulo-spfc-footballlogos-org.png"),
    ...
    34: ("Avaí", "avai-fc-footballlogos-org.png"),
    35: ("Santo André", "Santo_Andre_escudo.png"),
